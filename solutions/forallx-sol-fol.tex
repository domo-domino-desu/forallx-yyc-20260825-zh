...
\myanswer{
\begin{ekey}
\item[\text{论域}] episodes (psychological and televised)
...
Using the following symbolization key:
\begin{ekey}
\item[\text{论域}] people and dishes at a potluck
...
Using the following symbolization key:
\begin{ekey}
\item[\text{论域}] cards in a standard deck
...
\begin{ekey}
\item[\text{论域}] animals in the world
