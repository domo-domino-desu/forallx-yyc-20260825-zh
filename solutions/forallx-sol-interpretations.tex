...
\begin{compactlist}
	\item \gap{x} is older than \gap{y} \hfill\myanswer{$\atom{Y}{y,x}$}
	\item \gap{x} is \gap{y}'s mother \hfill\myanswer{$\atom{O}{y,x}
	\eand \atom{W}{x}$}
	\item \gap{x} and \gap{y} are siblings (note that you can't be your
	own sibling) \hfill\myanswer{$\exists z(\atom{O}{x,z} \eand
	\atom{O}{y,z}) \eand \enot x=y$}
	\item \gap{x} is \gap{y}'s brother \hfill\myanswer{$\exists z(\atom{O}{x,z} \eand
...
\begin{compactlist}
	\item Alex and Dana are sisters. \hfill\myanswer{$\exists z(\atom{O}{a,z} \eand
	...
	\item Alex's parents are the same age. \hfill\myanswer{$\forall
...
\begin{compactlist}
	\item Reflexive but not symmetric \hfill\myanswer{\gap{x} is no
	older than \gap{y}}
	\item Symmetric but not transitive \hfill\myanswer{\gap{x} is within
	1~km of \gap{y}}
	\item Transitive, symmetric, but not reflexive
	\hfill\myanswer{\gap{x} is a full (i.e., not half) sibling of \gap{y}}
\end{compactlist}
